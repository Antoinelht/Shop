...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 offset-md-3 form-control">
				<h3>LOGIN LECTEUR</h3>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 offset-md-3 form-control"> 
				<form action="" method="post">
					...
					<button id="button" type="submit" name="login" class="btn btn-info">LOGIN</button>&nbsp;&nbsp;&nbsp;<a href="signup.php">Je n'ai pas de compte</a>
				</form>
			</div>
		</div>
	</div>
